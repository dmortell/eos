<script>
 ...
 <Card>
	{#if footer}
		<Row><Col>Total work hours:</Col><Col class='left'>{totals.total}</Col>
			<Col class='right'>Client Reviewed:</Col><Col>___________</Col></Row>
		<Row><Col>Total work days:</Col><Col class='left'>{totals.days}</Col>
			<Col class='right'>Date:</Col><Col>___________</Col></Row>
	{:else}
		...
		<div>
			...
			<Row><Col>Client:</Col><Col class='left'>Client Name <Icon src={mdiPencil} class="icon noprint"/></Col><Col/></Row>
			<Row><Col>Month:</Col><Col class='left'>{format(month,'longmonth-year')}</Col><Col/></Row>
		</div>
		<Row class='printonly'><Col>Name:</Col><Col class='left'>{user.displayName}</Col><Col/></Row>
