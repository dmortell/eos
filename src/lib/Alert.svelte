<script>
	...
	import { alert } from '$js/stores.js'
	export let ms = 3000
	let visible, timeout

	const onMessageChange = (message, ms) => {		// see https://developer.mozilla.org/en-US/docs/Learn/Tools_and_testing/Client-side_JavaScript_frameworks/Svelte_stores
