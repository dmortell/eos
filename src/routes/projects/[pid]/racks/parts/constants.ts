...
export const DEVICE_W_MM = 445 // default rack-device width (19" internal, user standard)
...
export const DEFAULT_PALETTE: DeviceTemplate[] = [
	...
	{ id: 'sw24', label: 'Network Switch 1u 24p', description: '1U - Managed', type: 'switch', heightU: 1, portCount: 24, portType: 'RJ45', icon: 'server' },
	{ id: 'sw48', label: 'Network Switch 1u 48p', description: '1U - Managed', type: 'switch', heightU: 1, portCount: 48, portType: 'RJ45', icon: 'server' },
	{ id: 'sw2u', label: 'Network Switch 2u 48p', description: '2U - Managed', type: 'switch', heightU: 2, portCount: 48, portType: 'RJ45', icon: 'server' },
