<script lang="ts">
	...
	let tools = $derived([
		...
		{ detail:1, href: 'elevations', icon: 'server', label: 'Elevations', description: 'Racks, devices, port labels, reservations, and patching in one canvas.', },
		{ detail:0, href: 'racks?legacy=1', icon: 'server', label: 'Rack Elevations (legacy)', description: 'Superseded by Elevations — kept for plan view during the soak period.' },
		{ detail:0, href: 'frames?legacy=1', icon: 'rows', label: 'Patch Frames (legacy)', description: 'Superseded by Elevations (Locations tab + port grids).', },
		{ detail:0, href: 'patching?legacy=1', icon: 'cable', label: 'Patching (legacy)', description: 'Superseded by Elevations (patch mode + live patch list).', },
