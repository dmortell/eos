<script lang="ts">
	...
	import OutletProperties from './parts/OutletProperties.svelte'
	import TrunkProperties from './trunks/TrunkProperties.svelte'
  ...
  import { toast } from 'svelte-sonner';
	...
	let canvasRef: OutletCanvas | undefined = $state()
			...
			<div class="flex-1 min-h-0 relative">
				...
				{#if selectedTrunkIds.size > 0 && selectedTrunks.length > 0}
					<TrunkProperties
						...
						onupdateselected={updateSelectedTrunks}
						ondelete={deleteTrunks}
					/>
				{/if}
			</div>
