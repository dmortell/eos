...
export type Layer = { id: string; name: string; color: string; visible: boolean; locked: boolean; weight?: number; dash?: boolean }   // weight = non-scaling lineweight (screen px); dash = render outline dashed (openings)
