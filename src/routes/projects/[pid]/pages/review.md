...
at their base in an elevation (hit) · B24 elevation-native entities can't move vertically (moveEnt flat test by kind) · B25 Shift-press+move toggles nothing when released off the entity (minor).
