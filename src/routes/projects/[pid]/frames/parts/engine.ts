...
// `matchesFace` and `deriveFramesFromRacks` moved to `$lib/elevation/portmap.ts`
// — the single racks → frames → labels pipeline shared by Frames, Patching and
// the drawings viewports.
