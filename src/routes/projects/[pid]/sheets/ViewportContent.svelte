<script lang="ts">
	...
	import Model3dViewport from './tools/model3d/Model3dViewport.svelte'
...
{:else if vp.source.kind === 'model3d'}
	<Model3dViewport {vp} {vps} {zoom} {active} {view} {onview} hidden={layers.hidden} locked={layers.locked} />
{/if}
