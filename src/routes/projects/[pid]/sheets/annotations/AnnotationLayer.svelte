...
<script lang="ts">
	...
	// smallest object under the cursor wins the click. A line's footprint is its actual
	// hit band (length × screen-constant width) — so a long line still beats the big box
