...
export const BOX_KINDS = new Set(['text', 'rect', 'ellipse', 'cloud', 'symbol', 'callout', 'image'])
...
/** SVG dash-array (in non-scaling px) for a dash style. */
export const dashArray = (d?: string) => (d === 'dashed' ? '6 4' : d === 'dotted' ? '1.5 4' : undefined)
