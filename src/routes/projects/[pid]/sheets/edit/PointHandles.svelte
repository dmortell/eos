...
<script lang="ts">
	...
	let { editor, points, hMm = 110, onmove }: {
...
{#each points as p, i (i)}
	...
	<circle cx={p.x} cy={p.y} r={hMm * 0.6} fill="white" stroke={HL} stroke-width="1.5" vector-effect="non-scaling-stroke" style:cursor="crosshair" style:pointer-events="auto" onmousedown={(e: MouseEvent) => startDragPt(i, e)} />
{/each}
